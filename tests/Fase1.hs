...
runTestsT1 = runTestsTT $ TestList [testsT1]
runTestsT2 = runTestsTT $ TestList [testsT2]
runTestsT3 = runTestsTT $ TestList [testsT3]
runTestsT4 = runTestsTT $ TestList [testsT4]
runTests = runTestsTT $ TestList [testsT1, testsT2, testsT3, testsT4]
